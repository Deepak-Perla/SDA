...
def record_predictAudio():
    ...
    file = "E:/Study/Sem_5/seminar_studies/proj_v2.1/maincode/Dataset/Actor_*/*.wav" #Recorded audio filepath
    ...
    y_predictAudio = loaded_model.predict(np.array(x_predictAudio))
    time.sleep(3)
